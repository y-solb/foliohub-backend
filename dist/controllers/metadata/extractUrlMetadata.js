...
exports.extractUrlMetadata = void 0;
const axios_1 = __importDefault(require("axios"));
const cheerio = __importStar(require("cheerio"));
const customError_1 = require("../../libs/customError");
const extractUrlMetadata = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { link } = req.query;
    if (typeof link !== 'string')
        return next(new customError_1.CustomError(400, 'General', 'link이 string 타입이 아닙니다.'));
    try {
